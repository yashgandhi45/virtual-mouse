...
class handDetector():
    ...
    def fingersUp(self):
        ...
        for id in range(8, 21, 4):
            ...
            if len(self.lmList) >= id and len(self.lmList) >= id - 2:
    ...
    #####NEWWWWWWWWWW###########
    def getPinchDistance(self):
        if len(self.lmList) >= 4 and len(self.lmList) >= 8:
            x1, y1 = self.lmList[4][1:]
            x2, y2 = self.lmList[8][1:]
